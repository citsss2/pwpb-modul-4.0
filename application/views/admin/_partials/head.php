<head>
    ...
    <!-- Title Page-->
    <title<!-- Title Page-->
<title><?php echo "tokosaya" .": ". ucfirst($this->uri->segment(1)) ."  ". ucfirst($this->uri->segment(2)) ?></title>Dashboard</title>
...
<link href="<?php echo base_url('assets/CoolAdmin-master/datatables/dataTables.bootstrap4.css') ?>" rel="stylesheet">
